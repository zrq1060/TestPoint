...
public class TestEnterListFragmentProcessor extends AbstractProcessor {
    ...
    private void createClass(String customClassName) {
        ...
        TypeSpec classSpec = TypeSpec.classBuilder(Constants.CUSTOM_LIST_FRAGMENT_HELPER_CLASS_NAME)
                ...
                .build();
        // -编辑JavaFile
        JavaFile javaFile = JavaFile.builder(Constants.CUSTOM_LIST_FRAGMENT_HELPER_PACKAGE, classSpec)
                .build();
        try {
